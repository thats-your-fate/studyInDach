...
const landingPages: Record<string, LandingConfig> = {
	...
	"estudar-na-austria": {
		slug: "estudar-na-austria",
		title: "Estudar na Áustria",
		metaTitle: "Estudar na Áustria: programas de estudo e universidades | Study in DACH",
		description: "Compare programas de estudo na Áustria por nível, idioma, custos, formato e área.",
		intro: "A Áustria oferece programas em universidades públicas, privadas e instituições aplicadas. Use esta página para comparar opções e depois confirme requisitos, prazos e taxas diretamente no site oficial da universidade.",
		filters: { country: "Austria" },
		notes: [
			"Confira se o programa exige alemão, inglês ou uma combinação de idiomas.",
			"Verifique taxas semestrais, mensalidades e possíveis regras específicas para estudantes internacionais.",
			"Compare localização, custo de vida e formato de estudo antes de montar sua lista.",
			"Confirme prazos e documentos na página oficial do programa.",
		],
		faq: [
			{ question: "Posso estudar na Áustria em inglês?", answer: "Sim, há programas em inglês e programas mistos, especialmente em nível de mestrado. Verifique sempre o idioma oficial do programa." },
			{ question: "Os prazos austríacos são iguais aos da Alemanha?", answer: "Não necessariamente. Prazos variam por universidade, programa e perfil do candidato." },
			{ question: "Como comparar programas na Áustria?", answer: "Compare nível, área, idioma, cidade, custos, requisitos acadêmicos e página oficial de candidatura." },
		],
		relatedLinks: [
			{ label: "Programas na Áustria", href: "/pt-br/cursos?country=Austria" },
			{ label: "Programas em inglês", href: "/pt-br/programas-em-ingles" },
			{ label: "Guia de estudos", href: "/pt-br/guia-de-estudos" },
		],
	},
	"estudar-na-suica": {
		slug: "estudar-na-suica",
		title: "Estudar na Suíça",
		metaTitle: "Estudar na Suíça: programas de estudo e universidades | Study in DACH",
		description: "Compare programas de estudo na Suíça por área, idioma, universidade, custos e formato.",
		intro: "A Suíça tem programas em diferentes regiões linguísticas e instituições com perfis variados. Compare idioma, cidade, custos e requisitos antes de criar sua lista curta.",
		filters: { country: "Switzerland" },
		notes: [
			"Observe o idioma local da região e o idioma oficial de ensino do programa.",
			"Considere custo de vida, seguro e taxas como parte do planejamento.",
			"Verifique se o programa tem foco acadêmico, aplicado ou internacional.",
			"Confirme todos os requisitos diretamente com a universidade.",
		],
		faq: [
			{ question: "A Suíça tem programas em inglês?", answer: "Sim, especialmente em alguns mestrados e programas internacionais. A disponibilidade varia por área." },
			{ question: "O custo de vida deve entrar na comparação?", answer: "Sim. O custo de vida suíço pode pesar bastante e deve ser considerado junto com taxas e mensalidades." },
			{ question: "Como escolher entre regiões linguísticas?", answer: "Compare idioma de ensino, idioma local, cidade, rede profissional e requisitos oficiais." },
		],
		relatedLinks: [
			{ label: "Programas na Suíça", href: "/pt-br/cursos?country=Switzerland" },
			{ label: "Programas em inglês", href: "/pt-br/programas-em-ingles" },
			{ label: "Guia de estudos", href: "/pt-br/guia-de-estudos" },
		],
	},
	"programas-em-ingles": {
		slug: "programas-em-ingles",
		title: "Programas em inglês na Alemanha, Áustria e Suíça",
		metaTitle: "Programas em inglês no DACH | Study in DACH",
		description: "Encontre programas com inglês como idioma de ensino na Alemanha, Áustria e Suíça.",
		intro: "Programas em inglês são populares entre estudantes internacionais, mas podem ter exigências acadêmicas, certificados e componentes em outros idiomas. Use esta página como ponto de partida e confirme os detalhes oficiais.",
		filters: { languageOfInstruction: "English" },
		notes: [
			"Confirme se o programa é totalmente em inglês ou se combina idiomas.",
			"Verifique certificados aceitos e pontuação mínima.",
			"Alguns programas recomendam alemão, francês ou italiano para estágio e vida cotidiana.",
			"Compare requisitos acadêmicos antes de selecionar programas.",
		],
		faq: [
			{ question: "Programa em inglês significa que não preciso de outro idioma?", answer: "Nem sempre. Alguns programas têm módulos, estágios ou requisitos práticos em outro idioma." },
			{ question: "Há bacharelados em inglês?", answer: "Sim, mas a oferta tende a ser maior em nível de mestrado. Use os filtros para refinar por nível." },
			{ question: "Como encontrar opções adequadas?", answer: "Filtre por idioma English e depois refine por país, nível, área e tipo de mensalidade." },
		],
		relatedLinks: [
			{ label: "Catálogo filtrado", href: "/pt-br/cursos?languageOfInstruction=English" },
			{ label: "Mestrado em inglês na Alemanha", href: "/pt-br/mestrado-na-alemanha-em-ingles" },
			{ label: "Guia de estudos", href: "/pt-br/guia-de-estudos" },
		],
	},

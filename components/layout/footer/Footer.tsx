...
const disclaimer = 'Program data is collected from public university sources and may be incomplete or outdated. Always verify deadlines, fees, and admission requirements on the official university website.'
						...
						<div className="container position-relative z-2">
							<div className="row pt-120 pb-120 g-lg-0 g-5">
								<div className="col-lg-3">
									<div className="text-center position-relative">
										...
										<h6 className="pb-3 text-white">Explore</h6>
										<div className="d-flex flex-column">
											<Link href="/courses"><p className="hover-effect-1 opacity-75 text-white">Courses</p></Link>
								...
								<div className="col-lg-6">
									<div className="position-relative text-center">
										...
										<p className="fw-regular mt-5 mb-4 text-center px-md-10 px-0 opacity-75 text-white">
											A discovery platform for degree programs in Germany, Austria, and Switzerland.
										</p>
							...
							<div className="bg-green-3 rounded-3 p-md-5 p-4 text-center text-lg-start d-flex align-items-center justify-content-lg-between justify-content-center flex-wrap position-relative overflow-hidden">
								<h5 className="mb-lg-0 mb-4">
									Explore programs by country, degree level, field, and language.
								</h5>
								<Link href="/courses" className="btn btn-primary hover-up">
									Browse programs
							...
							<div className="text-center py-4 d-flex align-items-center justify-content-center flex-wrap">
								<p className="text-white opacity-50 mb-0">© {new Date().getFullYear()} Study in DACH. All Rights Reserved.</p>
							</div>
						</div>
					</div>

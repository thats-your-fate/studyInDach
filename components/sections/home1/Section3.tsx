...
export default function Section3({ locale = 'en' }: { locale?: PublicLocale }) {
	...
	return (
		<>
			...
			<section className="elearning-home-section-2 position-relative overflow-hidden pt-120 pb-120 rounded-bottom-4 bg-white z-35">
				<div className="container">
					<div className="row">
						...
						<div className="col-lg-8 ps-lg-10">
							<div className="d-flex gap-4 py-5 border-top border-bottom" data-aos="fade-left" data-aos-delay={0}>
								<Link href="/#" className="icon">
									<svg xmlns="http://www.w3.org/2000/svg" width={50} height={50} viewBox="0 0 50 50" fill="none">
										<g clipPath="url(#clip0_550_1222)">
							...
							<div className="d-flex gap-4 py-5 border-bottom" data-aos="fade-left" data-aos-delay={200}>
								<Link href="/#" className="icon">
									<svg xmlns="http://www.w3.org/2000/svg" width={50} height={50} viewBox="0 0 50 50" fill="none">
										<g clipPath="url(#clip0_550_1220)">
							...
							<div className="d-flex gap-4 py-5 border-bottom" data-aos="fade-left" data-aos-delay={400}>
								<Link href="/#" className="icon">
							...
							<div className="d-flex gap-4 py-5 border-bottom" data-aos="fade-left" data-aos-delay={600}>
								<Link href="/#" className="icon">
